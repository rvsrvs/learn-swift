/*:
 ...
 Classes and structures share many features.  Both types of types can:
...
/*:
 ...
 All types in Swift are either value types or reference types.  Only class types are reference types.
 All other types of types are value types.
 
 For structs and enums in particular this means that when passing an instance 
 of a structure or enumeration to a function (or assigning an instance of a structure 
 or enumeration to another value), the structure or enumeration is copied.
